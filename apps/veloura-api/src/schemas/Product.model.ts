...
import { ProductMainCategory, ProductJewelrySubCategory, ProductStatus, ProductMaterial, ProductGender, ProductLocation} from '../libs/enums/product.enum';
...
ProductSchema.index(
  { productMainCategory: 1, productSubcategory: 1, productTitle: 1, productPrice: 1 },
  { unique: true }
);
